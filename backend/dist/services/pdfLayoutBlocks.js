...
exports.blocksFromPlainText = blocksFromPlainText;
exports.reconstructParagraphBlocks = reconstructParagraphBlocks;
...
function reconstructParagraphBlocks(layoutText) {
    ...
    for (let i = 0; i < segments.length; i++) {
        ...
        if (!isListItem && !centered && level > 0) {
            ...
            const prevMatches = prevSeg && !prevSeg.wrapped && !isCentered(prevSeg.lines[0]) && closeIndent(prevSeg.lines[0].leading, line.leading);
            const nextMatches = nextSeg && !nextSeg.wrapped && !isCentered(nextSeg.lines[0]) && closeIndent(nextSeg.lines[0].leading, line.leading);
...
//# sourceMappingURL=pdfLayoutBlocks.js.map